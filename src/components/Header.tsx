  ...
  return (
    <>
      ...
      <div className="bg-brand-blue text-primary-foreground text-sm py-2 px-4 flex items-center justify-center gap-6">
        <a href="tel:918824453320" className="flex items-center gap-1 hover:text-brand-orange transition-colors duration-200">
          <Phone size={14} />
          +91-8824453320
        </a>
        <span className="text-primary-foreground/50">|</span>
        <a href="mailto:info@fullstacklearning.com" className="hover:text-brand-orange transition-colors duration-200">
      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <a
              href="#enquiry"
              onClick={(e) => { e.preventDefault(); handleNavClick("#enquiry"); }}
