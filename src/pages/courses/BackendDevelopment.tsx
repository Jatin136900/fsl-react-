    ...
    <main className={`container mx-auto px-4 py-12 transition-all duration-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-6"}`}>
      <div className="max-w-4xl mx-auto bg-card rounded-3xl p-8 shadow-lg border border-border">
        <header className="flex items-center gap-6">
          <div className={`p-3 rounded-xl bg-gradient-to-br ${course.color}`}>BE</div>
          <div>
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            <h2 className="text-xl font-semibold">What you'll cover</h2>
            ...
            <h3 className="text-lg font-semibold mt-6">Assessment</h3>
            <p className="text-muted-foreground mt-2">Regular quizzes, hands-on labs and a final capstone API project.</p>
          </div>
        ...
        <div className="mt-8">
          <h3 className="text-lg font-semibold">Tools & Stack</h3>
          <p className="text-muted-foreground mt-2">Node.js, Express, Postgres/MongoDB, Docker, JWT, Testing</p>
        </div>
      </div>
